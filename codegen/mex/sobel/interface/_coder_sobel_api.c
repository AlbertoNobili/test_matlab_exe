...
static const mxArray *emlrt_marshallOut(const emxArray_uint8_T *u)
{
  ...
  y = NULL;
  m = emlrtCreateNumericArray(2, iv, mxUINT8_CLASS, mxREAL);
...
void sobel_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *plhs
               [1])
{
  ...
  emxInit_real_T(&st, &originalImage, 2, &g_emlrtRTEI, true);
  emxInit_uint8_T(&st, &edgeImage, 2, &g_emlrtRTEI, true);
